...
import { FaCheckCircle, FaStream, FaBullhorn, FaChartBar, FaCalendarAlt, FaBell, FaHome } from "react-icons/fa";
...
export default function CourseStatus() {
  return (
    <div id="wd-course-status" style={{ width: "350px" }}>
      ...
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
        <FaCalendarAlt className="me-2 fs-5" /> View Course Calendar
      </Button>
      <Button variant="secondary" size="lg" className="w-100 mt-1 text-start">
