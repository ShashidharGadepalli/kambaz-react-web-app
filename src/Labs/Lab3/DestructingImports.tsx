        ...
        <div id="wd-destructuring-imports">
            ...
            <table className="table table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Math.multiply(4, 2) = {Math.multiply(4, 2)}</td>
                        <td>Matematica.multiply(4, 2) =
                            {Matematica.multiply(4, 2)}</td>
                        <td>multiply(4, 2) = {multiply(4, 2)}</td>
                    </tr>
                    <tr>
                        <td>Math.divide(18, 9) = {Math.divide(18, 9)}</td>
                        <td>Matematica.divide(18, 9) =
                            {Matematica.divide(18, 9)}</td>
                        <td>divide(18, 9) = {divide(18, 9)}</td>
                    </tr>
